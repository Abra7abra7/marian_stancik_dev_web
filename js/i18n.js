// Marian Stancik Personal Brand — Centralized Multilingual Engine (EN, SK, DE, PL) v5
...
const translations = {
  "en": {
    ...
    "bookIntro": "Pick a time that works for you. All calls are 30 minutes via Google Meet — free and no commitment.",
    "bookCard1Cta": "Book via Google Meet",
    "bookCard2Cta": "Book via Google Meet",
    "bookCard3Cta": "Book via Google Meet",
    "bookNote": "Prefer email? Reach out directly at <a href=\"mailto:marianstancik@agentmail.to\" style=\"color:#CD7F32;\">marianstancik@agentmail.to</a>.",
  ...
  "de": {
    ...
    "faq2a": "Ein KI-GEO-Audit prüft die Sichtbarkeit Ihrer Website für KI-Suchmaschinen wie Perplexity, ChatGPT Search, Claude und Google SGE. <strong>199 €</strong> — einmaliges Audit, Bericht in 48 Stunden.",
    ...
    "bookLabel": "📅 Gespräch vereinbaren",
    "bookHeading": "Lassen Sie uns über Ihr Projekt sprechen.",
    "bookIntro": "Wählen Sie einen passenden Termin. Alle Gespräche dauern 30 Minuten via Google Meet — kostenlos und unverbindlich.",
    "bookCard1Cta": "Über Google Meet buchen",
    "bookCard2Cta": "Über Google Meet buchen",
    "bookCard3Cta": "Über Google Meet buchen",
    "bookNote": "Alternativ schreiben Sie an <a href=\"mailto:marianstancik@agentmail.to\" style=\"color:#CD7F32;\">marianstancik@agentmail.to</a>.",
  ...
  "pl": {
    ...
    "faq2a": "Audyt AI GEO sprawdza widoczność strony w wyszukiwarkach AI (Perplexity, ChatGPT, Claude, Google SGE). <strong>199 €</strong> — jednorazowy audyt, raport w 48h.",
    ...
    "bookLabel": "📅 Umów rozmowę",
    "bookHeading": "Porozmawiajmy o Twoim projekcie.",
    "bookIntro": "Wybierz dogodny termin. Wszystkie rozmowy trwają 30 minut przez Google Meet — bezpłatnie i bez zobowiązań.",
    "bookCard1Cta": "Umów przez Google Meet",
    "bookCard2Cta": "Umów przez Google Meet",
    "bookCard3Cta": "Umów przez Google Meet",
    "bookNote": "Alternatywnie napisz na <a href=\"mailto:marianstancik@agentmail.to\" style=\"color:#CD7F32;\">marianstancik@agentmail.to</a>.",
  ...
  "sk": {
    ...
    "bookLabel": "📅 Rezervovať hovor",
    "bookHeading": "Poďme sa porozprávať o vašom projekte.",
    "bookIntro": "Vyberte si termín, ktorý vám vyhovuje. Všetky hovory trvajú 30 minút cez Google Meet — nezáväzne a bezplatne.",
    "bookCard1Cta": "Rezervovať cez Google Meet",
    "bookCard2Cta": "Rezervovať cez Google Meet",
    "bookCard3Cta": "Rezervovať cez Google Meet",
    "bookNote": "Alternatívne mi napíšte na <a href=\"mailto:marianstancik@agentmail.to\" style=\"color:#CD7F32;\">marianstancik@agentmail.to</a> a dohodneme sa individuálne.",
